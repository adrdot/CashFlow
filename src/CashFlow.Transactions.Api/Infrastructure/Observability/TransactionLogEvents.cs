...
public static class TransactionLogEvents
{
    ...
    public static readonly EventId TransactionPersistenceFailed = new(2002, nameof(TransactionPersistenceFailed));

    public static readonly EventId TransactionIdempotentReplay = new(2003, nameof(TransactionIdempotentReplay));
